...
//This function will be used to read user input in all function.It will also handle input output exceptions that may occur during the program.()
String input()
{
    String choice = "null";//this variable is returned to the functions
...
void menu_1()
{
    ...
    while(true)
    {
        ...
        switch(choice)
            {
                //The first 7 cases call the same function but diferrent values depending on the user's okoa amount.
                case "0":
                    okoa_jahazi(20);
                    break;
                case "1":
